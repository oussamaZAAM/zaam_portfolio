        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Rooms"
              description="Social Network Application with many functionalities: Chat, Posting, creating Rooms."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="QHSE"
              description="Application for the management of the quality of business services."
